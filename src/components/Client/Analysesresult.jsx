...
export default function Analysesresult() {
  return (
    <div className="py-10 bg-white py-20">
      <div className="container w-11/12 mx-auto">
        <div className="border-green-500 bg-green-200 flex w-full rounded-lg border-l-[6px] px-7 py-8 md:p-9">
          <div className="bg-green-500 mr-5 flex h-[34px] w-full max-w-[34px] items-center justify-center rounded-md">
            <svg
              width="18"
              height="18"
              viewBox="0 0 18 18"
          ...
          <div className="w-full">
            ...
            <p className="text-base leading-relaxed text-body-color">
              Cette page vous permet de vérifier si vos résultats d'analyse sanguine sont prêts. Entrez vos informations pour consulter l'état de vos analyses sans vous déplacer au laboratoire.
            </p>
          </div>
        </div>
      </div>
